...
<head>
  ...
  <title>Remove Supervisor - SPAS</title>
...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Remove Supervisor</h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Remove Supervisor</li>
    </ol>
          ...
          if ($result = mysqli_query($connection, $query)) {
            if (mysqli_num_rows($result) > 0) {
              while($row = mysqli_fetch_array($result)) {
                  ...
                  echo $firstName . " " . $lastName . " (" . $supervisorID . ")";
                  echo "<br>";
                  echo '<form action="../../php/removeSupervisor.php" method="post" role="form">';
